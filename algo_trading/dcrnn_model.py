...
class EncoderModel(nn.Module, Seq2SeqAttrs):
    def __init__(self, adj_mx, **model_kwargs):
        ...
        file_name = model_kwargs.get('wavelet_name')
        how = model_kwargs.get('how')
        L = model_kwargs.get('L')
        dim = model_kwargs.get('dim')
        self.dcgru_layers = nn.ModuleList(
            [DCGRUCell(self.rnn_units, adj_mx, self.max_diffusion_step, self.num_nodes, L, dim, file_name, how,
